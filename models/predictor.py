...
class Predict:
    ...
    def __call__(self, text):
        return Picture(img_name='images/Fireworks.svg')


from models.parser import GraphParser
from tools.knowledge import VocabBase
from models.components import KeywordGrounder, GraphManipulator, LayerSlicer, LayerGround
...
""")
    ...
    def __score(self, cons, reas, lamb=0.6):
